...
export class MovieActions  {
    ...
    private commentValidationSchema() {
        return yup.object({
    ...
    public async createReview(movieId:number, request:Request) {
        ...
        try {
          await this.commentValidationSchema().validate(r, { abortEarly: false })
    ...
    public async create(request:Request) : Promise< ActionData<Movie|null> > {
        ...
        try {
            await this.movieValidationSchema().validate(m, { abortEarly: false })
    ...
    public async edit(id: number, request:Request) : Promise < ActionData<Movie|null> > {
        const form = await request.formData();
